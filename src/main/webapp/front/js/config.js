...
var centerMenu = [
    ...
    ,{
        name: '代驾司机收藏',
        url: '../daijiaCollection/list.jsp'
    }
    ,{
        name: '代驾司机订单',
        url: '../daijiaOrder/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '代驾司机',
        url: './pages/daijia/list.jsp'
    },

]

var adminurl =  "http://localhost:8080/daijiayingyongxitong/jsp/login.jsp";
