            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">工号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="daijiaUuidNumber" id="daijiaUuidNumber"  placeholder="工号"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">代驾司机姓名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="daijiaName" id="daijiaName"  placeholder="代驾司机姓名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">代驾司机手机号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="daijiaPhone" id="daijiaPhone"  lay-verify="phone|required"   placeholder="代驾司机手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">代驾司机身份证号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="daijiaIdNumber" id="daijiaIdNumber"  lay-verify="identity|required"   placeholder="代驾司机身份证号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
...
<!-- 邮箱 -->
                <div class="layui-form-item" pane>
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="daijiaEmail" id="daijiaEmail"  lay-verify="email|required"   placeholder="电子邮箱" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">司机驾龄:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="daijiaJialing" id="daijiaJialing"  placeholder="司机驾龄"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">司机热度:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="daijiaClicknum" id="daijiaClicknum"  lay-verify="integer|required"   placeholder="司机热度" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
