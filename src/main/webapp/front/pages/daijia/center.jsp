...
<div style=" width:auto; margin:-47px 10px 0px auto">
    ...
    <ul id="category">
        <li v-for="(item,index) in centerMenu" v-bind:key="index" :class="index==0?'bbbb':''">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="daijiaUuidNumber" id="daijiaUuidNumber" lay-verify="required" placeholder="工号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="daijiaName" id="daijiaName" lay-verify="required" placeholder="代驾司机姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="daijiaPhone" id="daijiaPhone"  lay-verify="required|phone"   placeholder="代驾司机手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="daijiaIdNumber" id="daijiaIdNumber"  lay-verify="required|identity"   placeholder="代驾司机身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="daijiaEmail" id="daijiaEmail"  lay-verify="required|email"   placeholder="电子邮箱" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="daijiaPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="daijiaPhoto" name="daijiaPhoto"/>
							</div>
						</div>

						<div class="layui-form-item">
							<div class="layui-input-block">
								<button type="button" class="layui-btn btn-theme" id="daijiaPhotoUpload">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="daijiaJialing" id="daijiaJialing" lay-verify="required" placeholder="司机驾龄" autocomplete="off" class="layui-input">
							</div>
						</div>
			<div class="layui-form-item">
                <div class="layui-block">
                    <label class="layui-form-label">司机原价/每公里</label>
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="daijiaOldMoney" id="daijiaOldMoney"  placeholder="司机原价/每公里" autocomplete="off" class="layui-input" style="width: 500px">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    <label class="layui-form-label">现价/每公里</label>
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="daijiaNewMoney" id="daijiaNewMoney"  placeholder="现价/每公里" autocomplete="off" class="layui-input" style="width: 500px">
                        <div class="layui-form-mid layui-word-aux">
                            <i class="layui-icon" style="font-size: 20px;color: red;">&#xe65e;</i>
                            <a id="btn-recharge" href="javascript:void(0)">点我充值</a>
                        </div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="daijiaClicknum" id="daijiaClicknum"  lay-verify="required|integer"   placeholder="司机热度" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                upload.render({
                    ...
                    // 上传成功
                        ...
                        if (res.code == 0) {
                            ...
                            jquery('#daijiaPhoto').val(url);
                            jquery('#daijiaPhotoImg').attr('src', url);
                        } else {
                            layer.msg(res.msg, {
                                time: 2000,
                                icon: 5
                ...
                http.request(`daijia/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#daijiaPhotoImg").attr("src", data.data.daijiaPhoto);
                });
