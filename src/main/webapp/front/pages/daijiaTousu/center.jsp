    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="daijiaTousuUuidNumber" id="daijiaTousuUuidNumber" lay-verify="required" placeholder="投诉编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="daijiaTousuName" id="daijiaTousuName" lay-verify="required" placeholder="投诉名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="daijiaTousuTypes" id="daijiaTousuTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="daijiaTousuChuliText" id="daijiaTousuChuliText" lay-verify="required" placeholder="处理结果" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`daijiaTousu/session`, 'get', {}, function (data) {
                    // 表单赋值
