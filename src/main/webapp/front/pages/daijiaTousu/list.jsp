        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-fff">
            <div class="ng-inmod-ini">
                    <div class="index_titlebox">
                        <h3 class="index_title">代驾投诉展示</h3>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="daijiaTousuUuidNumber" id="daijiaTousuUuidNumber" placeholder="投诉编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="daijiaTousuName" id="daijiaTousuName" placeholder="投诉名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="daijiaTousuTypes" id="daijiaTousuTypes" lay-filter="daijiaTousuTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in daijiaTousuTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            daijiaTousuTypesList : [],
            daijiaTousuTypes: 0,//类型
            limit: 8,
    ...
    // 当前表的字典表
        ...
        function daijiaTousuTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=daijia_tousu_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.daijiaTousuTypesList = res.data.list;
                }
            });
        }
        ...
        function pageList() {
            ...
            if (jquery('#daijiaTousuUuidNumber').val() != null && jquery('#daijiaTousuUuidNumber').val() != "" && jquery('#daijiaTousuUuidNumber').val() != "null" ) {
                param['daijiaTousuUuidNumber'] = jquery('#daijiaTousuUuidNumber').val();
            }
                         
            if (jquery('#daijiaTousuName').val() != null && jquery('#daijiaTousuName').val() != "" && jquery('#daijiaTousuName').val() != "null" ) {
                param['daijiaTousuName'] = jquery('#daijiaTousuName').val();
            }
         
            var daijiaTousuTypes = $("#daijiaTousuTypes").find("option:selected").val();
            if (daijiaTousuTypes != null && daijiaTousuTypes != "" && daijiaTousuTypes != "null") {
                param['daijiaTousuTypes'] = daijiaTousuTypes;
            }
                                        

            // 获取列表数据
            http.request('daijiaTousu/list', 'get', param, function(res) {
