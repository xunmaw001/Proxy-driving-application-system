...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">代驾投诉管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">代驾投诉列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">代驾投诉列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="daijiaTousuUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="投诉编号" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        投诉名称
                                        <div class="layui-input-inline">
                                            <input type="text" id="daijiaTousuNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        投诉类型
                                        <div class="layui-input-inline">
                                            <select name="daijiaTousuTypesSelectSearch"  style="width: 150px;" id="daijiaTousuTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //投诉编号
            var daijiaTousuUuidNumberSearchInput = $('#daijiaTousuUuidNumberSearch');
            if( daijiaTousuUuidNumberSearchInput != null){
                if (daijiaTousuUuidNumberSearchInput.val() != null && daijiaTousuUuidNumberSearchInput.val() != '') {
                    searchForm.daijiaTousuUuidNumber = $('#daijiaTousuUuidNumberSearch').val();
                }
            }
             
            //投诉名称
            var daijiaTousuNameSearchInput = $('#daijiaTousuNameSearch');
            if( daijiaTousuNameSearchInput != null){
                if (daijiaTousuNameSearchInput.val() != null && daijiaTousuNameSearchInput.val() != '') {
                    searchForm.daijiaTousuName = $('#daijiaTousuNameSearch').val();
                }
            }
     
                //投诉类型
            var daijiaTousuTypesSelectSearchInput = document.getElementById("daijiaTousuTypesSelectSearch");
            if(daijiaTousuTypesSelectSearchInput != null){
                var daijiaTousuTypesIndex = daijiaTousuTypesSelectSearchInput.selectedIndex;
                if( daijiaTousuTypesIndex  != 0){
                    searchForm.daijiaTousuTypes= document.getElementById("daijiaTousuTypesSelectSearch").options[daijiaTousuTypesIndex].value;
                }
            }
                                getDataList();
        }
        ...
        function getDataList() {
            http("daijiaTousu/page", "GET", {
                ...
                daijiaTousuDelete: 1,
                //本表的
                daijiaTousuUuidNumber: searchForm.daijiaTousuUuidNumber,
                daijiaTousuName: searchForm.daijiaTousuName,
                daijiaTousuTypes: searchForm.daijiaTousuTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //投诉编号
            var daijiaTousuUuidNumberCell = document.createElement('td');
            daijiaTousuUuidNumberCell.innerHTML = item.daijiaTousuUuidNumber;
            row.appendChild(daijiaTousuUuidNumberCell);


            //投诉名称
            var daijiaTousuNameCell = document.createElement('td');
            daijiaTousuNameCell.innerHTML = item.daijiaTousuName;
            row.appendChild(daijiaTousuNameCell);


            //投诉类型
            var daijiaTousuTypesCell = document.createElement('td');
            daijiaTousuTypesCell.innerHTML = item.daijiaTousuValue;
            row.appendChild(daijiaTousuTypesCell);
            ...
            //处理结果
            var daijiaTousuChuliTextCell = document.createElement('td');
            daijiaTousuChuliTextCell.innerHTML = item.daijiaTousuChuliText;
            row.appendChild(daijiaTousuChuliTextCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("daijiaTousu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("adddaijiaTousu", "adddaijiaTousu");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function daijiaTousuTypesSelectSearch() {
            var daijiaTousuTypesSelectSearch = document.getElementById('daijiaTousuTypesSelectSearch');
            if(daijiaTousuTypesSelectSearch != null) {
                daijiaTousuTypesSelectSearch.add(new Option('-请选择-',''));
                if (daijiaTousuTypesOptions != null && daijiaTousuTypesOptions.length > 0){
                    for (var i = 0; i < daijiaTousuTypesOptions.length; i++) {
                            daijiaTousuTypesSelectSearch.add(new Option(daijiaTousuTypesOptions[i].indexName,daijiaTousuTypesOptions[i].codeIndex));
                    }
                }
            }
        }
