    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑代驾司机评价</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">代驾司机评价管理</li>
                        <li class="breadcrumb-item active">编辑代驾司机评价</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">代驾司机评价信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 daijiaCommentbackTextDiv">
                                        <label>评价内容</label>
                                        <textarea style="width: 450px"  id="daijiaCommentbackText" name="daijiaCommentbackText" class="form-control"placeholder="评价内容"></textarea>
                                    </div>
...
<script>
    ...
    var tableName = "daijiaCommentback";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("daijiaCommentback/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('adddaijiaCommentback');
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                daijiaId: "required",
                yonghuId: "required",
                daijiaCommentbackText: "required",
                replyText: "required",
            },
            messages: {
                daijiaId: "代驾司机不能为空",
                yonghuId: "用户不能为空",
                daijiaCommentbackText: "评价内容不能为空",
                replyText: "回复内容不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var adddaijiaCommentback = window.sessionStorage.getItem("adddaijiaCommentback");
        if (adddaijiaCommentback != null && adddaijiaCommentback != "" && adddaijiaCommentback != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("daijiaCommentback/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#daijiaCommentbackText").val(ruleForm.daijiaCommentbackText);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            $('#daijiaCommentbackText').attr('readonly', 'readonly');
