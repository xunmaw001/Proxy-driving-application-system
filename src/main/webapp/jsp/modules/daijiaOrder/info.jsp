            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">代驾司机订单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="daijiaId" name="daijiaId" v-model="ruleForm.daijiaId" readonly type="hidden">
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="buyLicheng" name="buyLicheng" class="form-control"
                                               v-model="ruleForm.buyLicheng" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="daijiaOrderTruePrice" name="daijiaOrderTruePrice" class="form-control"
                                               v-model="ruleForm.daijiaOrderTruePrice" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>支付类型</label>
                                    <input style="width: 450px" id="daijiaOrderPaymentValue" name="daijiaOrderPaymentValue" class="form-control"
                                           v-model="ruleForm.daijiaOrderPaymentValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "daijiaOrder/info/" + id,
