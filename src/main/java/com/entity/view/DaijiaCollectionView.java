 ...
 */
@TableName("daijia_collection")
public class DaijiaCollectionView extends DaijiaCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String daijiaCollectionValue;
	...
	public DaijiaCollectionView() {

	}

	public DaijiaCollectionView(DaijiaCollectionEntity daijiaCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, daijiaCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getDaijiaCollectionValue() {
				return daijiaCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setDaijiaCollectionValue(String daijiaCollectionValue) {
				this.daijiaCollectionValue = daijiaCollectionValue;
			}
