...
public class DaijiaLiuyanView extends DaijiaLiuyanEntity implements Serializable {
	...
	public DaijiaLiuyanView() {

	}

	public DaijiaLiuyanView(DaijiaLiuyanEntity daijiaLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, daijiaLiuyanEntity);
