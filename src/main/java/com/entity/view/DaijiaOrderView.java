...
public class DaijiaOrderView extends DaijiaOrderEntity implements Serializable {
	...
	public DaijiaOrderView() {

	}

	public DaijiaOrderView(DaijiaOrderEntity daijiaOrderEntity) {
		try {
			BeanUtils.copyProperties(this, daijiaOrderEntity);
