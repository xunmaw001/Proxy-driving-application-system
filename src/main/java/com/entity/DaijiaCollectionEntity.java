...
public class DaijiaCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public DaijiaCollectionEntity() {

	}

	public DaijiaCollectionEntity(T t) {
		try {
     ...
     * 类型
     */
    @TableField(value = "daijia_collection_types")
    ...
    public String toString() {
        return "DaijiaCollection{" +
            "id=" + id +
            ", daijiaId=" + daijiaId +
            ", yonghuId=" + yonghuId +
            ", daijiaCollectionTypes=" + daijiaCollectionTypes +
